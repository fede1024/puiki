...
(defpartial info-section []
  ...
  [:p "Il sito è diviso in " (link-to "/channel/list" "canali")
   ...
   " Le varie risposte vengono poi ordinate in base ai giudizi degli studenti stessi, così che la risposta ritenuta migliore sia subito visualizzata. Ad ogni nuova risposta alle domande che hai effettuato ti arriverà una notifica."]
...
(defpage "/" []
  (layout "Poli Connect"
    (info-section)
    [:h2.section (link-to "/channel/list" "Elenco canali")]
